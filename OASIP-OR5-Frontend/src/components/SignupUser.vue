            ...
            <div class="modal-content-box bg-base-200 rounded-2xl">
                ...
                <form>
                    <div class="grid justify-center">
                        ...
                        <div class="py-3">
                            ...
                            <p class="error-signup"
                                v-if="errorStatus.filedErrors.name === 'User name is already exists'">Name is already
                                exists</p>
                        </div>
                    </div>
                    ...
                    <div class="grid justify-center">
                        ...
                        <div class="py-3">
                            <input class="form-element bg-base-100 border-b-2 italic" maxlength="14"
                                v-model="newUser.confirmPassword" placeholder="Confirm Password" type="password"
                                :class="{ 'styleError': errorConfirm || notMatch }">
                    ...
                    <div class="grid justify-center">
                        ...
                        <div class="py-3">
                            <select class="select form-element bg-base-100 border-b-2 italic"
                                :class="{ 'styleError': errorAddRole }" v-model="newUser.role">
